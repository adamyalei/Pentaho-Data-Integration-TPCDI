...
select 'DimCustomer inactive customers', BatchID::TEXT, Result, 'Inactive customer count matches Audit table' from (
	select distinct BatchID, case when
		(select messageData::NUMERIC from DImessages where MessageType = 'Validation' and BatchID = a.BatchID and 'DimCustomer' = MessageSource and 'Inactive customers' = MessageText) = 
